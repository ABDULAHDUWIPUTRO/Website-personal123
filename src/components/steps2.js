          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text28">Early Life</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text24">
                      Brief overview of the person&apos;s childhood and
                      upbringing.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text26">Education</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Summary of the individual&apos;s educational background
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Career</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text31">Personal Life</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      Insight into the personal interests, hobbies, and family
